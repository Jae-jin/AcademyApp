...
public class Showtipsofdaytest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showtipsofdaytest);
    ...
    public void onBackPressed() {
        ...
        // Alert을 이용해 종료시키기
        AlertDialog.Builder dialog = new AlertDialog.Builder(Showtipsofdaytest.this);
        dialog  .setTitle("시험 종료")
                .setMessage("일간 시험 시작화면으로 돌아가시겠습니까?")
