...
public class Weekteststart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekteststart);
        ...
        startTest = (Button)findViewById(R.id.startTestw);
    ...
    public void onBackPressed() {
        ...
        // Alert을 이용해 종료시키기
        AlertDialog.Builder dialog = new AlertDialog.Builder(Weekteststart.this);
        dialog  .setTitle("시험 종료")
                .setMessage("주간 시험을 종료하고 main화면으로 가시겠습니까?")
